...
> In THE_PAPER we used a dataset of 8748 species and eight PC dimensions, and a model with 36 nested random terms: one for the whole phylogeny, eight for each super-order containing at least 15 species and 27 for each order containing at least 15 species and one residual term.
